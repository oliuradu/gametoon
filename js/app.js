...
var game1button = document.querySelector("#game2").addEventListener("click", openGame2);
var game1button = document.querySelector("#game3").addEventListener("click", openGame3);
